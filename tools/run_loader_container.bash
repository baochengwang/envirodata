...
docker run --rm --mount source=envirodata_cache,target=/cache --network envirodata_network mbees/envirodata:latest load_data --services Noise_mapping config.yaml